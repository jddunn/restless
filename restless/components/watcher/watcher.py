...
class Watcher:
    ...
    def constant_scan(self):
        ...
        Returns:
            list: List of filenames (with absolute paths) that have been updated or saved since the last `scan` was performed (in descending order of modification timestamps).
        """
        return

    def check_for_new_data(self):
        """
        Checks to see if there's any new incoming data saved or updated to the system (verified by file modification timestamps).
        """
        return
